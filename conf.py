...
BLOG_TITLE = "Packet Capture"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://github.com/necromuralist/packet_capture/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://github.com/necromuralist/packet_capture/"
BLOG_EMAIL = "necromuralist@protonmail.com"
BLOG_DESCRIPTION = "Documentation For Some Packet Capturing Code"  # (translatable)
